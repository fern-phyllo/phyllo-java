...
@JsonDeserialize(
    builder = SwitchProduct.Builder.class
)
public final class SwitchProduct {
  private final boolean isSupported;

  private int _cachedHashCode;

  SwitchProduct(boolean isSupported) {
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof SwitchProduct && equalTo((SwitchProduct) other);
  }

  private boolean equalTo(SwitchProduct other) {
  ...
  public String toString() {
    return "SwitchProduct{" + "isSupported: " + isSupported + "}";
  }
  ...
  public interface IsSupportedStage {
    ...
    Builder from(SwitchProduct other);
  }
  ...
  static final class Builder implements IsSupportedStage, _FinalStage {
    ...
    @Override
    public Builder from(SwitchProduct other) {
    ...
    @Override
    public SwitchProduct build() {
      return new SwitchProduct(isSupported);
    }
  }
}
