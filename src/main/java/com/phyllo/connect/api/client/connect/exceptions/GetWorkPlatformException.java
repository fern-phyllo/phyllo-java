...
@JsonDeserialize(
    using = GetWorkPlatformException.Deserializer.class
)
public final class GetWorkPlatformException extends Exception {
  private final Value value;

  private int statusCode;

  private GetWorkPlatformException(Value value, int statusCode) {
    this.value = value;
  ...
  public static GetWorkPlatformException other(Object unknownValue, int statusCode) {
    return new GetWorkPlatformException(new UnknownErrorValue(unknownValue), statusCode);
  }
  ...
  private static final class UnknownErrorValue implements Value {
    ...
    public String toString() {
      return "GetWorkPlatformException{" + "unknownValue: " + unknownValue + "}";
    }
  }

  static final class Deserializer extends JsonDeserializer<GetWorkPlatformException> {
    @Override
    public GetWorkPlatformException deserialize(JsonParser p, DeserializationContext ctx) throws
        IOException {
      Value value = ctx.readValue(p, Value.class);
      int statusCode = (int) ctx.getAttribute("statusCode");
      return new GetWorkPlatformException(value, statusCode);
    }
  }
}
