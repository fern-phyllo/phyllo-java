...
@JsonDeserialize(
    using = GetAllAccountsException.Deserializer.class
)
public final class GetAllAccountsException extends Exception {
  private final Value value;

  private int statusCode;

  private GetAllAccountsException(Value value, int statusCode) {
    this.value = value;
  ...
  public static GetAllAccountsException other(Object unknownValue, int statusCode) {
    return new GetAllAccountsException(new UnknownErrorValue(unknownValue), statusCode);
  }
  ...
  private static final class UnknownErrorValue implements Value {
    ...
    public String toString() {
      return "GetAllAccountsException{" + "unknownValue: " + unknownValue + "}";
    }
  }

  static final class Deserializer extends JsonDeserializer<GetAllAccountsException> {
    @Override
    public GetAllAccountsException deserialize(JsonParser p, DeserializationContext ctx) throws
        IOException {
      Value value = ctx.readValue(p, Value.class);
      int statusCode = (int) ctx.getAttribute("statusCode");
      return new GetAllAccountsException(value, statusCode);
    }
  }
}
