...
@JsonDeserialize(
    using = GetUserByExernalIdException.Deserializer.class
)
public final class GetUserByExernalIdException extends Exception {
  private final Value value;

  private int statusCode;

  private GetUserByExernalIdException(Value value, int statusCode) {
    this.value = value;
  ...
  public static GetUserByExernalIdException other(Object unknownValue, int statusCode) {
    return new GetUserByExernalIdException(new UnknownErrorValue(unknownValue), statusCode);
  }
  ...
  private static final class UnknownErrorValue implements Value {
    ...
    public String toString() {
      return "GetUserByExernalIdException{" + "unknownValue: " + unknownValue + "}";
    }
  }

  static final class Deserializer extends JsonDeserializer<GetUserByExernalIdException> {
    @Override
    public GetUserByExernalIdException deserialize(JsonParser p, DeserializationContext ctx) throws
        IOException {
      Value value = ctx.readValue(p, Value.class);
      int statusCode = (int) ctx.getAttribute("statusCode");
      return new GetUserByExernalIdException(value, statusCode);
    }
  }
}
