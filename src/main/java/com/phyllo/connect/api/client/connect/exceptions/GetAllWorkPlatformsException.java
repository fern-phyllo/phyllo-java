...
@JsonDeserialize(
    using = GetAllWorkPlatformsException.Deserializer.class
)
public final class GetAllWorkPlatformsException extends Exception {
  private final Value value;

  private int statusCode;

  private GetAllWorkPlatformsException(Value value, int statusCode) {
    this.value = value;
  ...
  public static GetAllWorkPlatformsException other(Object unknownValue, int statusCode) {
    return new GetAllWorkPlatformsException(new UnknownErrorValue(unknownValue), statusCode);
  }
  ...
  private static final class UnknownErrorValue implements Value {
    ...
    public String toString() {
      return "GetAllWorkPlatformsException{" + "unknownValue: " + unknownValue + "}";
    }
  }

  static final class Deserializer extends JsonDeserializer<GetAllWorkPlatformsException> {
    @Override
    public GetAllWorkPlatformsException deserialize(JsonParser p, DeserializationContext ctx) throws
        IOException {
      Value value = ctx.readValue(p, Value.class);
      int statusCode = (int) ctx.getAttribute("statusCode");
      return new GetAllWorkPlatformsException(value, statusCode);
    }
  }
}
