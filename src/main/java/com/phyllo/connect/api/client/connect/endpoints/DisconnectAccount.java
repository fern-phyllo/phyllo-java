...
public final class DisconnectAccount {
  ...
  public static final class Request {
    ...
    Request(Optional<BasicAuth> authOverride, AccountId id) {
    ...
    public String toString() {
      return "DisconnectAccount.Request{" + "authOverride: " + authOverride + ", id: " + id + "}";
    }
    ...
    static final class Builder implements IdStage, _FinalStage {
      ...
      @Override
      public _FinalStage id(AccountId id) {
        this.id = id;
        return this;
      }
