...
@JsonDeserialize(
    using = CreateUserException.Deserializer.class
)
public final class CreateUserException extends Exception {
  ...
  private CreateUserException(Value value, int statusCode) {
    this.value = value;
  ...
  public static CreateUserException other(Object unknownValue, int statusCode) {
    return new CreateUserException(new UnknownErrorValue(unknownValue), statusCode);
  }
  ...
  private static final class UnknownErrorValue implements Value {
    ...
    public String toString() {
      return "CreateUserException{" + "unknownValue: " + unknownValue + "}";
    }
  }

  static final class Deserializer extends JsonDeserializer<CreateUserException> {
    @Override
    public CreateUserException deserialize(JsonParser p, DeserializationContext ctx) throws
        IOException {
      Value value = ctx.readValue(p, Value.class);
      int statusCode = (int) ctx.getAttribute("statusCode");
      return new CreateUserException(value, statusCode);
    }
  }
}
