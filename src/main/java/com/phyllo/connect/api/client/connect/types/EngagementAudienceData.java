...
@JsonDeserialize(
    builder = EngagementAudienceData.Builder.class
)
public final class EngagementAudienceData {
  ...
  EngagementAudienceData(DataStatus status, Optional<String> lastSyncAt,
      Optional<String> refreshSince, Optional<String> dataAvailableFrom,
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof EngagementAudienceData && equalTo((EngagementAudienceData) other);
  }

  private boolean equalTo(EngagementAudienceData other) {
  ...
  public String toString() {
    return "EngagementAudienceData{" + "status: " + status + ", lastSyncAt: " + lastSyncAt + ", refreshSince: " + refreshSince + ", dataAvailableFrom: " + dataAvailableFrom + ", monitorType: " + monitorType + "}";
  }
  ...
  public interface StatusStage {
    ...
    Builder from(EngagementAudienceData other);
  }
  ...
  static final class Builder implements StatusStage, MonitorTypeStage, _FinalStage {
    ...
    @Override
    public Builder from(EngagementAudienceData other) {
    ...
    @Override
    public EngagementAudienceData build() {
      return new EngagementAudienceData(status, lastSyncAt, refreshSince, dataAvailableFrom, monitorType);
    }
  }
}
